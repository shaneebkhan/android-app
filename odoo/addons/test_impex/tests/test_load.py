...
class test_m2o(ImporterCase):
    ...
    def test_by_names(self):
        ...
        self.assertEqual(
            result['messages'],
            [message(u"Found multiple matches for field 'Value/Value' (2 matches)",
                     type='warning')])
        self.assertEqual(len(result['ids']), 1)
        self.assertEqual([
            (record1.id, name1)
    ...
    def test_fail_by_implicit_id(self):
        ...
        self.assertEqual(result['messages'], [
            message(u"No matching record found for name '%s' in field 'Value/Value'" % id,
    ...
    def test_fail_noids(self):
        ...
        self.assertEqual(result['messages'], [message(
            ...
            u"in field 'Value/Value'", moreinfo=moreaction(
...
class test_m2m(ImporterCase):
    ...
    def test_noids(self):
        ...
        self.assertEqual(result['messages'], [message(
            ...
            u"'Value/Value'", moreinfo=moreaction(
    ...
    def test_nonames(self):
        ...
        self.assertEqual(result['messages'], [message(
            ...
            u"field 'Value/Value'", moreinfo=moreaction(
...
class test_o2m(ImporterCase):
    ...
    def test_name_get(self):
        ...
        result = self.import_(
            ...
            [['5', s]])
        self.assertEqual(result['messages'], [message(
            u"No matching record found for name '%s' in field 'Value/Value'" % s,
