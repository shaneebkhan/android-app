    ...
    .. code-block:: javascript
        ...
        var IncorrectWidget = Widget.extend({
            start: function () {
                ...
                this.$el.hasClass(....) // First mistake: might fail because super in not finished

                // second mistake: the promise of the parent is lost
            },
        });
        ...
        var CorrectWidget = Widget.extend({
            start: function () {
                ...
                return this._super.apply(arguments).then(function() {
                    self.$el.hasClass(....) // this works and no promise is lost
                });
            },
        });
