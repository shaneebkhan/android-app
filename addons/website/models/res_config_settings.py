...
class ResConfigSettings(models.TransientModel):
    ...
    favicon = fields.Image('Favicon', related='website_id.favicon', store=False)
    social_default_image = fields.Image('Default Social Share Image', related='website_id.social_default_image', store=False)
