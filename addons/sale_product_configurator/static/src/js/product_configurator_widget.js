...
ProductConfiguratorWidget.include({
    ...
    */
     ...
     * {OdooEvent ev}
     *    {Array} ev.data.options the various selected optional products
    ...
    _onFieldChanged: function (ev) {
        ...
        this.options = (ev.data && ev.data.options) || this.options;
    ...
    _onLineConfigured: function () {
        ...
        if (self.options && self.options.length !== 0) {
            self.trigger_up('add_record', {
                context: self._productsToRecords(self.options),
