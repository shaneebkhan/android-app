    ...
    def get_single_product_variant(self):
        ...
        if self.product_variant_count == 1 and not self.has_configurable_attributes:
            ...
            for optional_product in self.product_variant_id.optional_product_ids:
                if optional_product.has_dynamic_attributes() or optional_product._get_possible_variants(self.product_variant_id.variant_product_template_attribute_value_ids):
