...
var BasicModel = AbstractModel.extend({
    ...
    _makeDefaultRecord: function (modelName, params) {
        ...
        var fieldNames = Object.keys(fieldsInfo[params.viewType]);
        ...
        if (parentRecord) {
            fieldNames = _.union(fieldNames, Object.keys(parentRecord.fieldsInfo[parentRecord.viewType]));
            fieldsInfo = _.defaults({}, fieldsInfo, parentRecord.fieldsInfo);
            fields = _.extend({}, fields, parentRecord.fields);
        }
