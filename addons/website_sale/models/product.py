...
class ProductPublicCategory(models.Model):
    ...
    product_tmpl_ids = fields.Many2many('product.template', relation='product_template_public_categories')
...
class ProductTemplate(models.Model):
    ...
    public_categ_ids = fields.Many2many('product.public.category', relation='product_template_public_categories', string='Website Product Category',
