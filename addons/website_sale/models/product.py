...
class ProductPublicCategory(models.Model):
    ...
    product_tmpl_ids = fields.Many2many('product.template', relation='product_public_categ')
...
class ProductTemplate(models.Model):
    ...
    public_categ_ids = fields.Many2many('product.public.category', relation='product_public_categ', string='Website Product Category',
