...
class User(models.Model):
    ...
    last_check_in = fields.Datetime(related='employee_id.last_attendance_id.check_in', store=True)
    last_check_out = fields.Datetime(related='employee_id.last_attendance_id.check_out', store=True)
