        ...
        self._cr.execute("""
            CREATE or REPLACE view %s AS (
                SELECT
                    ...
                    max(l_order.date) AS last_order_date
                ...
                LEFT JOIN lunch_order l_order ON l_order.product_id = product.id AND l_order.user_id = users.id AND l_order.date <= current_date
