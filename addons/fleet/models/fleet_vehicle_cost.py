...
class FleetVehicleLogContract(models.Model):
    ...
    ins_ref = fields.Char('Vendor Reference', size=64, copy=False)
    ...
    odometer = fields.Float(compute="_get_odometer", inverse='_set_odometer', string='Creation Contract Odometer',
    ...
    def create(self, vals_list):
        for data in vals_list:
            if 'odometer' in data and not data['odometer']:
                ...
                del data['odometer']
        return super(FleetVehicleLogContract, self).create(vals_list)
