...
class ProductProduct(models.Model):
    ...
    def _compute_average_price(self, qty_invoiced, qty_to_invoice, stock_moves):
        ...
        :param stock_moves: recordset of `stock.move` expected to be sorted by date
        :returns:
        :rtype: float
        """
        self.ensure_one()
        ...
        candidates = stock_moves\
            ...
            .sorted()
        qty_to_take_on_candidates = qty_to_invoice  # FIXME sle: should we only consider out stock move?
        tmp_value = 0  # to accumulate the value taken on the candidates
        for candidate in candidates:
