...
class Rating(models.Model):
    ...
    def _group_model_ids(self, model_id_dict={}):
        for record in self:
            if record.res_model and record.res_id:
                if record.res_model in model_id_dict:
                    model_id_dict[record.res_model].add(record.res_id)
                else:
                    model_id_dict[record.res_model] = {record.res_id}
