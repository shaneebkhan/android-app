...
class TestMailPerformance(TransactionCase):
    ...
    def test_write_mail_with_recomputation(self):
        ...
        with self.assertQueryCount(admin=5, demo=5):
...
class TestAdvMailPerformance(TransactionCase):
    ...
    def test_adv_activity_full(self):
        ...
        with self.assertQueryCount(margin=1, admin=44, emp=49):  # test_mail only: 35 - 40
        ...
        with self.assertQueryCount(margin=1, admin=81, emp=112):  # test_mail only: 67 - 95
    ...
    def test_message_assignation_email(self):
        ...
        with self.assertQueryCount(margin=1, admin=101, emp=142):  # test_mail only: 90 - 128
            record.write({
    ...
    def test_message_assignation_inbox(self):
        ...
        with self.assertQueryCount(margin=1, admin=42, emp=60):  # test_mail only: 40 - 57
            record.write({
                'user_id': self.user_test.id,
            })
    ...
    def test_message_log_with_post(self):
        ...
        with self.assertQueryCount(admin=29, emp=40):  # test_mail only: 27 - 37
            record.message_post(
    ...
    def test_message_post_no_notification(self):
        ...
        with self.assertQueryCount(admin=30, emp=41):  # test_mail only: 28 - 38
            record.message_post(
    ...
    def test_message_post_one_email_notification(self):
        ...
        with self.assertQueryCount(margin=1, admin=86, emp=112):  # com runbot 86 - 112 // test_mail only: 82 - 107
            record.message_post(
    ...
    def test_message_post_one_inbox_notification(self):
        ...
        with self.assertQueryCount(margin=1, admin=41, emp=53):  # test_mail only: 39 - 50
            record.message_post(
...
class TestHeavyMailPerformance(TransactionCase):
    ...
    def test_complex_message_post(self):
        ...
        with self.assertQueryCount(admin=129, emp=161):  # test_mail only: 123 - 154
            record.message_post(
    ...
    def test_complex_message_post_template(self):
        ...
        with self.assertQueryCount(admin=190, emp=237):  # com runbot: 190 - 237 // test_mail only: 180 - 225
    ...
    def test_complex_message_subscribe(self):
        ...
        with self.assertQueryCount(admin=21, emp=21):  # test_mail only: 21 - 21
    ...
    def test_complex_tracking_assignation(self):
        ...
        with self.assertQueryCount(admin=111, emp=152):  # test_mail only: 100 - 138
    ...
    def test_complex_tracking_subscription_create(self):
        ...
        with self.assertQueryCount(margin=1, admin=355, emp=428):  # test_mail only: 337 - 407
            rec = self.env['mail.test.full'].create({
                'name': 'Test',
    ...
    def test_complex_tracking_subscription_subtype(self):
        ...
        with self.assertQueryCount(admin=244, emp=282):  # test_mail only: 238 - 275
            rec.write({
                'name': 'Test2',
                'umbrella_id': self.umbrella.id,
                })
    ...
    def test_complex_tracking_subscription_write(self):
        ...
        with self.assertQueryCount(admin=246, emp=285):  # test_mail only: 239 - 278
            rec.write({
                'name': 'Test2',
                'umbrella_id': umbrella_id,
                'customer_id': customer_id,
    ...
    def test_complex_tracking_template(self):
        ...
        with self.assertQueryCount(admin=100, emp=140):  # test_mail only: 92 - 129
            rec.write({
                'name': 'Test2',
                'customer_id': customer_id,
                'user_id': self.env.uid,
