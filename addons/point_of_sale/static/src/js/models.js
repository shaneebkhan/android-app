...
exports.PosModel = Backbone.Model.extend({
    ...
    models: [
    {
        ...
        model:  'pos.session',
        fields: ['id', 'journal_ids','name','user_id','config_id','start_at','stop_at','sequence_number','login_number','payment_method_ids'],
...
exports.Paymentline = Backbone.Model.extend({
    ...
    export_as_JSON: function(){
        ...
        if(this.payment_method.is_cash_count && amount > 0) {
