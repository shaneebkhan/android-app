...
class TestMrpCancelMO(TestMrpCommon):
    ...
    def test_cancel_mo_without_routing_3(self):
        ...
        # Cancel the MO
        result_of_cancel = manufacturing_order.action_cancel()
        # Check the cancel returned a Wizard
        self.assertEqual(result_of_cancel['res_model'], 'mrp.confirm.cancel.production',
            "cancel should return action to open the Confirm Cancel wizard")
        manufacturing_order._action_cancel()  # Force cancel
    ...
    def test_cancel_mo_with_routing(self):
        ...
        manufacturing_order = mo = mo_data[0]
        bom = mo_data[1]
