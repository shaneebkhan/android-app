...
class TestBoM(TestMrpCommon):
    ...
    def test_12_multi_level_variants2(self):
        ...
        sofa_red = product_template.attribute_line_ids[0].ptal_product_template_attribute_value_ids[0]
        sofa_blue = product_template.attribute_line_ids[0].ptal_product_template_attribute_value_ids[1]

        sofa_big = product_template.attribute_line_ids[1].ptal_product_template_attribute_value_ids[0]
        sofa_medium = product_template.attribute_line_ids[1].ptal_product_template_attribute_value_ids[1]
        ...
        for combination, consumed_products in dict_consumed_products.items():
            product = product_template.product_variant_ids.filtered(lambda p: p.variant_product_template_attribute_value_ids == combination)
    ...
    def test_21_bom_report_variant(self):
        ...
        self.car_gps_yes = self.car_gps_attribute_line.ptal_product_template_attribute_value_ids[0]
        self.car_gps_no = self.car_gps_attribute_line.ptal_product_template_attribute_value_ids[1]
        ...
        self.car_color_red = self.car_color_attribute_line.ptal_product_template_attribute_value_ids[0]
        self.car_color_blue = self.car_color_attribute_line.ptal_product_template_attribute_value_ids[1]
        ...
        self.paint_color_red = self.paint_color_attribute_line.ptal_product_template_attribute_value_ids[0]
        self.paint_color_blue = self.paint_color_attribute_line.ptal_product_template_attribute_value_ids[1]
        ...
        self.dashboard_gps_yes = self.dashboard_gps_attribute_line.ptal_product_template_attribute_value_ids[0]
        self.dashboard_gps_no = self.dashboard_gps_attribute_line.ptal_product_template_attribute_value_ids[1]
        ...
        self.dashboard_color_red = self.dashboard_color_attribute_line.ptal_product_template_attribute_value_ids[0]
        self.dashboard_color_blue = self.dashboard_color_attribute_line.ptal_product_template_attribute_value_ids[1]
