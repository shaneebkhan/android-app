...
class HolidaysAllocation(models.Model):
    ...
    def _check_approval_update(self, state):
        ...
        if not current_employee:
            return
        is_officer = self.env.sumode or self.env.user.has_group('hr_holidays.group_hr_holidays_user')
        is_manager = self.env.sumode or self.env.user.has_group('hr_holidays.group_hr_holidays_manager')
        for holiday in self:
