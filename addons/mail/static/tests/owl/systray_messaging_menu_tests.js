...
QUnit.test('basic rendering', async function (assert) {
    ...
    assert.strictEqual(
        document
            .querySelectorAll('.o_mail_component_systray_messaging_menu')
            .length,
        1,
        "should have systray messaging menu");
    assert.notOk(
        document
            .querySelector('.o_mail_component_systray_messaging_menu')
            .classList
            .contains('show'),
