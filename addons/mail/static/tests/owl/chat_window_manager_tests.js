...
QUnit.test('initial mount', async function (assert) {
    ...
    assert.strictEqual(
        document
            .querySelectorAll('.o_mail_component_chat_window_manager')
            .length,
        1,
...
QUnit.test('chat window new message: basic rendering', async function (assert) {
    ...
    document
        .querySelector(`
            .o_mail_component_systray_messaging_menu
            > a`)
        .click();
    ...
    assert.strictEqual(
        document
            .querySelectorAll(`
                .o_mail_component_chat_window_manager
                > .o_chat_window`)
            .length,
        1,
    ...
    assert.strictEqual(
        document
            .querySelectorAll(`
                .o_mail_component_chat_window_manager
                > .o_chat_window
                > .o_mail_component_chat_window_header`)
            .length,
        1,
    ...
    assert.strictEqual(
        document
            ...
            .length,
        1,
        "should have a part for selection");
    assert.strictEqual(
        document
            .querySelectorAll(`
                .o_mail_component_chat_window_manager
...
QUnit.test('chat window: basic rendering', async function (assert) {
    ...
    document
        .querySelector(`
            .o_mail_component_systray_messaging_menu
            > .dropdown-menu
            > .o_mail_component_thread_preview_list
            > .o_preview`)
        .click();
    await testUtils.nextTick(); // re-render
...
QUnit.test('open 2 different chat windows: enough screen width', async function (assert) {
    ...
    document
        .querySelector(`
            ...
            > .dropdown-menu
            > .o_mail_component_thread_preview_list
            > .o_preview[data-thread-local-id="mail.channel_10"]`)
        .click();
    await testUtils.nextTick(); // re-render
    ...
    assert.strictEqual(
        document
            .querySelectorAll(`
                .o_mail_component_chat_window_manager
                > .o_chat_window[data-thread-local-id="mail.channel_10"]`)
            .length,
        1,
    ...
    document
        .querySelector(`
            ...
            > .dropdown-menu
            > .o_mail_component_thread_preview_list
            > .o_preview[data-thread-local-id="mail.channel_20"]`)
        .click();
    await testUtils.nextTick(); // re-render
    ...
    assert.strictEqual(
        document
            .querySelectorAll(`
                .o_mail_component_chat_window_manager
                > .o_chat_window[data-thread-local-id="mail.channel_20"]`)
            .length,
        1,
...
QUnit.test('open 3 different chat windows: not enough screen width', async function (assert) {
    ...
    document
        .querySelector(`
            ...
            > .dropdown-menu
            > .o_mail_component_thread_preview_list
            > .o_preview[data-thread-local-id="mail.channel_1"]`)
        .click();
    await testUtils.nextTick(); // re-render
    ...
    document
        .querySelector(`
            ...
            > .dropdown-menu
            > .o_mail_component_thread_preview_list
            > .o_preview[data-thread-local-id="mail.channel_2"]`)
        .click();
    await testUtils.nextTick(); // re-render
    ...
    document
        .querySelector(`
            ...
            > .dropdown-menu
            > .o_mail_component_thread_preview_list
            > .o_preview[data-thread-local-id="mail.channel_3"]`)
        .click();
    await testUtils.nextTick(); // re-render
    ...
    assert.strictEqual(
        document
            .querySelectorAll(`
                .o_mail_component_chat_window_manager
                > .o_chat_window[data-thread-local-id="mail.channel_1"]`)
            .length,
        1,
    ...
    assert.strictEqual(
        document
            .querySelectorAll(`
                .o_mail_component_chat_window_manager
                > .o_chat_window[data-thread-local-id="mail.channel_3"]`)
            .length,
        1,
