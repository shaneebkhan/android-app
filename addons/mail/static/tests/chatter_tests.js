...
QUnit.test('kanban activity widget with an activity', async function (assert) {
    ...
    assert.strictEqual($record.find('.o_activity_title').length, 2, "should have an activity scheduled");
    ...
    // check activity icon replace with fa-clock
...
QUnit.test('list activity exception widget with activity', async function (assert) {
    ...
    assert.strictEqual(list.$('.o_data_row').length, 2, "Should have two record");
