...
QUnit.test('filtered previews', async function (assert) {
    ...
    assert.strictEqual(document.querySelectorAll('.o_mail_wip_systray_messaging_menu > .dropdown-menu > .o_mail_wip_thread_preview_list > .o_preview[data-thread-lid="mail.channel_10"]').length, 1, "should have preview of chat");
    assert.strictEqual(document.querySelectorAll('.o_mail_wip_systray_messaging_menu > .dropdown-menu > .o_mail_wip_thread_preview_list > .o_preview[data-thread-lid="mail.channel_20"]').length, 1, "should have preview of channel");
    ...
    assert.strictEqual(document.querySelectorAll('.o_mail_wip_systray_messaging_menu > .dropdown-menu > .o_mail_wip_thread_preview_list > .o_preview').length, 1, "should have one preview");
    assert.strictEqual(document.querySelectorAll('.o_mail_wip_systray_messaging_menu > .dropdown-menu > .o_mail_wip_thread_preview_list > .o_preview[data-thread-lid="mail.channel_10"]').length, 1, "should have preview of chat");
    assert.strictEqual(document.querySelectorAll('.o_mail_wip_systray_messaging_menu > .dropdown-menu > .o_mail_wip_thread_preview_list > .o_preview[data-thread-lid="mail.channel_20"]').length, 0, "should not have preview of channel");

    document.querySelector('.o_mail_wip_systray_messaging_menu > .dropdown-menu > .o_header > .o_filter[data-filter="channel"]').click();
    await testUtils.nextTick(); // re-render

    assert.strictEqual(document.querySelectorAll('.o_mail_wip_systray_messaging_menu > .dropdown-menu > .o_mail_wip_thread_preview_list > .o_preview').length, 1, "should have one preview");
    assert.strictEqual(document.querySelectorAll('.o_mail_wip_systray_messaging_menu > .dropdown-menu > .o_mail_wip_thread_preview_list > .o_preview[data-thread-lid="mail.channel_10"]').length, 0, "should not have preview of chat");
    assert.strictEqual(document.querySelectorAll('.o_mail_wip_systray_messaging_menu > .dropdown-menu > .o_mail_wip_thread_preview_list > .o_preview[data-thread-lid="mail.channel_20"]').length, 1, "should have preview of channel");
