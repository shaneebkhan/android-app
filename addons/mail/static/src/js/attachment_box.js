...
var AttachmentBox = Widget.extend({
    ...
    events: {
        ...
        "click .o_upload_attachments_button": "_onClickAttachButton",
    },
    /**
     * @override
     ...
     */
    start: function () {
        this.$('.o_chatter_attachment_form .o_form_binary_form').change(this._onAddAttachment.bind(this));
    ...
    */
     ...
     * @param {Event} ev
     */
    _onClickAttachButton: function (ev) {
