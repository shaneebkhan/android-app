odoo.define('mail.wip.component.ComposerInput', function (require) {
'use strict';
...
class ComposerInput extends Component {
    ...
    constructor(...args) {
        ...
        this.template = 'mail.wip.component.ComposerInput';
    ...
    _configTributeCollectionItemChannel() {
        ...
        const collectionItem = {
            ...
            menuItemTemplate(item) {
                return `<div class="o_mail_wip_composer_input__mention_item">${item.string}</div>`;
            },
            selectTemplate(item) {
                if (!item) {
    ...
    _configTributeCollectionItemPartner() {
        ...
        const collectionItem = {
            lookup: 'name',
            menuItemTemplate(item) {
                return `<div class="o_mail_wip_composer_input__mention_item"
                             title="${
     ...
     * @return {Promise<mail.wip.model.Thread[]>}
     */
     ...
     * @param {string} keyword
     * @param {function} callback
     * @return {Promise<mail.wip.model.Partner[]>}
     */
