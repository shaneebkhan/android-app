odoo.define('mail.wip.component.AttachmentViewer', function (require) {
'use strict';
...
class AttachmentViewer extends Component {
    ...
    constructor(...args) {
        ...
        this.template = 'mail.wip.component.AttachmentViewer';
        this._translate = {
            x: 0,
            y: 0,
            dx: 0,
    ...
    _next() {
        ...
        this.env.store.commit('updateDialogInfo', {
...
AttachmentViewer.props = {
    attachment: {
        type: Object, // {mail.wip.model.Attachment}
    },
    info: {
        type: Object,
        shape: {
