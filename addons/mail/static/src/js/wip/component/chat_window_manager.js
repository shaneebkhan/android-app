odoo.define('mail.wip.component.ChatWindowManager', function (require) {
"use strict";

const ChatWindow = require('mail.wip.component.ChatWindow');
const HiddenMenu = require('mail.wip.component.ChatWindowHiddenMenu');
...
class ChatWindowManager extends Component {
    ...
    constructor(...args) {
        ...
        this.template = 'mail.wip.component.ChatWindowManager';
        // others
