odoo.define('mail.wip.component.Composer', function (require) {
'use strict';

const AttachmentList = require('mail.wip.component.AttachmentList');
const Input = require('mail.wip.component.ComposerInput');
const EmojisButton = require('mail.wip.component.EmojisButton');
...
class Composer extends Component {
    ...
    constructor(...args) {
        ...
        this.id = _.uniqueId('o_mail_wip_composer');
        this.state = {
            attachmentLocalIDs: [],
            showAllSuggestedRecipients: false,
        };
        this.template = 'mail.wip.component.Composer';
    }
