odoo.define('mail.wip.component.SystrayMessagingMenu', function (require) {
"use strict";
...
class SystrayMessagingMenu extends Component {
    ...
    constructor(...args) {
        ...
        this.template = 'mail.wip.component.SystrayMessagingMenu';
     ...
     */
    _onSelectThread(ev) {
        this.env.store.dispatch('openThread', {
...
return connect(
    ...
    (state, ownProps, getters) => {
        return {
            counter: getters.threadsGlobalUnreadCounter(),
