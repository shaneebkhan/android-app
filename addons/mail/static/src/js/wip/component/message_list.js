odoo.define('mail.wip.component.MessageList', function (require) {
'use strict';

const Message = require('mail.wip.component.Message');
...
class MessageList extends Component {
    constructor(...args) {
        ...
        this.template = 'mail.wip.component.MessageList';
    ...
    /**
     * @return {mail.wip.component.Message}
     */
    get firstMessageRef() {
...
MessageList.props = {
    ...
    messages: {
        type: Array,
        element: Object, // {mail.wip.model.Message}
    },
    thread: {
