odoo.define('mail.wip.component.ChatWindow', function (require) {
"use strict";

const AutocompleteInput = require('mail.wip.component.AutocompleteInput');
const Header = require('mail.wip.component.ChatWindowHeader');
...
class ChatWindow extends Component {
    ...
    constructor(...args) {
        ...
        this.template = 'mail.wip.component.ChatWindow';
