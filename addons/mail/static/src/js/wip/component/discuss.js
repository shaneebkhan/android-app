odoo.define('mail.wip.component.Discuss', function (require) {
'use strict';

const MobileMailboxSelection = require('mail.wip.component.DiscussMobileMailboxSelection');
const MobileNavbar = require('mail.wip.component.DiscussMobileNavbar');
const Sidebar = require('mail.wip.component.DiscussSidebar');
const Thread = require('mail.wip.component.Thread');
const ThreadPreviewList = require('mail.wip.component.ThreadPreviewList');
...
class Discuss extends Component {
    ...
    constructor(...args) {
        ...
        this.template = 'mail.wip.component.Discuss';
        /**
