...
QUnit.module('account', {
    ...
    QUnit.test('Reconcile temporarily and ask to check', function(assert){
        ...
        assert.equal($("button.o_reconcile.btn.btn-primary.btn-warning:first").length, 0, "should not display reconcile button in orange");
        $reconcileForm.find('.create_to_check input').click()
        assert.equal($("button.o_reconcile.btn.btn-primary.btn-warning:first").length, 1, "should display reconcile button in orange");
