...
class TaxAdjustments(models.TransientModel):
    ...
    country_id = fields.Many2one(string="Country", comodel_name='res.country', readonly=True, default=lambda self: self.env.company.country_id)
    ...
    def create_move(self):
        ...
        move_line_vals.append((0, 0, {
            ...
            'tax_base_amount': abs(self.amount),
        }))
