    ...
    def test_out_refund_line_onchange_product_1(self):
        ...
        self.assertAmlsValues(move.line_ids, [
            ...
            },
            {
                ...
                'product_id': False,
                'account_id': self._get_tax_refund_account(self.parent_tax_sale_1).id,
                'partner_id': self.partner_a.id,
                'product_uom_id': False,
                'quantity': 1.0,
                'discount': 0.0,
        ...
        self.assertAmlsValues(move.line_ids, [
            ...
            },
            {
                ...
                'product_id': False,
                'account_id': self._get_tax_refund_account(self.parent_tax_sale_2).id,
                'partner_id': self.partner_a.id,
                'product_uom_id': False,
                'quantity': 1.0,
                'discount': 0.0,
    ...
    def test_out_refund_line_onchange_taxes_2_price_include(self):
        ...
        self.assertAmlsValues(move.line_ids, [
            ...
            },
            {
                ...
                'product_id': False,
                'account_id': self._get_tax_refund_account(self.parent_tax_sale_1_incl).id,
                'partner_id': self.partner_a.id,
                'product_uom_id': False,
                'quantity': 1.0,
                'discount': 0.0,
    ...
    def test_out_refund_line_onchange_taxes_3_exigibility_on_payment(self):
        ...
        self.assertAmlsValues(move.line_ids, [
            ...
            },
            {
                ...
                'product_id': False,
                'account_id': self.parent_tax_sale_1_not_exigible.cash_basis_transition_account_id.id,
                'partner_id': self.partner_a.id,
                'product_uom_id': False,
                'quantity': 1.0,
                'discount': 0.0,
    ...
    def test_out_refund_onchange_partner_1(self):
        ...
        self.assertAmlsValues(move.line_ids, [
            ...
            },
            {
                ...
                'product_id': False,
                'account_id': self._get_tax_refund_account(self.parent_tax_sale_3).id,
                'partner_id': self.partner_b.id,
                'product_uom_id': False,
                'quantity': 1.0,
                'discount': 0.0,
