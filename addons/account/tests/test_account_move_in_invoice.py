    ...
    def test_in_invoice_line_onchange_product_1(self):
        ...
        self.assertAmlsValues(move.line_ids, [
            ...
            },
            {
                ...
                'product_id': False,
                'account_id': self._get_tax_account(self.parent_tax_purchase_2).id,
                'partner_id': self.partner_a.id,
                'product_uom_id': False,
                'quantity': 1.0,
                'discount': 0.0,
    ...
    def test_in_invoice_line_onchange_taxes_2_price_include(self):
        ...
        self.assertAmlsValues(move.line_ids, [
            ...
            },
            {
                ...
                'product_id': False,
                'account_id': self._get_tax_account(self.parent_tax_purchase_1_incl).id,
                'partner_id': self.partner_a.id,
                'product_uom_id': False,
                'quantity': 1.0,
                'discount': 0.0,
    ...
    def test_in_invoice_onchange_partner_1(self):
        ...
        self.assertAmlsValues(move.line_ids, [
            ...
            },
            {
                ...
                'product_id': False,
                'account_id': self._get_tax_account(self.parent_tax_purchase_3).id,
                'partner_id': self.partner_b.id,
                'product_uom_id': False,
                'quantity': 1.0,
                'discount': 0.0,
