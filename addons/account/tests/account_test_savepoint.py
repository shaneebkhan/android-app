...
class AccountingSavepointCase(SavepointCase):
    ...
    def setUpClass(cls):
        ...
        ref_tax_repartition_line = cls.parent_tax_sale_1.refund_repartition_line_ids.filtered(lambda line: line.repartition_type == 'tax')
        ref_tax_repartition_line.account_id = ref_tax_repartition_line.account_id.copy()
        ...
        cls.parent_acc_tax_1 = cls._get_tax_account(cls.parent_tax_sale_1)
        ...
        cls.parent_tax_sale_1_not_exigible.write({
            ...
            'cash_basis_transition_account_id': cls.parent_acc_tax_2.id,
    ...
    def _get_tax_account(tax):
        return tax.invoice_repartition_line_ids.filtered(lambda line: line.repartition_type == 'tax' and line.factor_percent == 100).account_id

    @staticmethod
    def _get_tax_refund_account(tax):
        return tax.refund_repartition_line_ids.filtered(lambda line: line.repartition_type == 'tax' and line.factor_percent == 100).account_id
