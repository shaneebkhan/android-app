...
class TestReconciliation(AccountingTestCase):
    ...
    def make_payment(self, invoice_record, bank_journal, amount=0.0, amount_currency=0.0, currency_id=None):
        ...
        line_id = invoice_record.line_ids.filtered(lambda line: line._is_invoice_payment_term_line())
...
class TestReconciliationExec(TestReconciliation):
    ...
    def test_statement_euro_invoice_usd_transaction_euro_full(self):
        ...
        receivable_line = move.line_ids.filtered(lambda line: line._is_invoice_payment_term_line())
    ...
    def test_reconciliation_cash_basis01(self):
        ...
        purchase_move = self.env['account.move'].create({
            ...
            'line_ids': [
                ...
                (0, 0, {'account_id': self.tax_waiting_account.id, 'debit': 16.67, 'credit': 0.0, 'tax_line_id': self.tax_cash_basis.id, 'tax_exigible': False}),
            ],
        })
        purchase_move.post()
    ...
    def test_reconciliation_cash_basis02(self):
        ...
        purchase_move = self.env['account.move'].create({
            ...
            'line_ids': [
                ...
                (0, 0, {'name': 'TaxLine0', 'account_id': tax_waiting_account10.id, 'debit': 5.0, 'credit': 0.0, 'tax_line_id': tax_cash_basis10percent.id, 'tax_exigible': False}),
                ...
                (0, 0, {'name': 'TaxLine1', 'account_id': self.tax_waiting_account.id, 'debit': 16.67, 'credit': 0.0, 'tax_line_id': self.tax_cash_basis.id, 'tax_exigible': False}),
            ],
        })
        purchase_move.post()
    ...
    def test_reconciliation_cash_basis_fx_02(self):
        ...
        # check amounts
        cash_basis_move1 = cash_basis_moves[0]
