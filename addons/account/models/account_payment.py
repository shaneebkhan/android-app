        ...
        for rec in self:
            ...
            if not rec.name:
                ...
                if rec.payment_type == 'transfer':
                    sequence_code = 'account.rec.transfer'
                else:
                    if rec.partner_type == 'customer':
                        if rec.payment_type == 'inbound':
                            sequence_code = 'account.rec.customer.invoice'
                        if rec.payment_type == 'outbound':
                            sequence_code = 'account.rec.customer.refund'
                    if rec.partner_type == 'supplier':
                        if rec.payment_type == 'inbound':
                            sequence_code = 'account.rec.supplier.refund'
                        if rec.payment_type == 'outbound':
                            sequence_code = 'account.rec.supplier.invoice'
