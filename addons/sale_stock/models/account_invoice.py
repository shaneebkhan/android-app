...
class AccountInvoiceLine(models.Model):
    ...
    def _get_anglo_saxon_price_unit(self):
        ...
        if so_line:
            ...
            qty_invoiced = sum([x.uom_id._compute_quantity(x.quantity, x.product_id.uom_id) for x in so_line.invoice_lines if x.invoice_id.state in ('open', 'in_payment', 'paid')])
            average_price_unit = self.product_id._compute_average_price(qty_invoiced, qty_to_invoice, stock_moves)
