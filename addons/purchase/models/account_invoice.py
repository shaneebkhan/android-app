                ...
                if line.get('invl_id', 0) == i_line.id and reference_account_id == line['account_id']:
                    ...
                    if i_line.product_id.cost_method != 'standard' and i_line.purchase_line_id:
                        ...
                        if self.type == 'in_refund':
                            valuation_stock_move = valuation_stock_move.filtered(lambda m: m.origin_returned_move_id)
                        else:
                            valuation_stock_move = valuation_stock_move.filtered(lambda m: not m.origin_returned_move_id)
