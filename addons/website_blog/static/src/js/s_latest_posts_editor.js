...
sOptions.registry.js_get_posts_limit = sOptions.Class.extend({
    ...
    _setActive: function () {
        ...
        this.$el.find('[data-posts-limit]').addBack('[data-posts-limit]').removeClass('active');
...
sOptions.registry.js_get_posts_selectBlog = sOptions.Class.extend({
    ...
    _updateMenu: function () {
        ...
        this.$el.find('[data-filter-by-blog-id]').addBack('[data-filter-by-blog-id]').removeClass('active');
