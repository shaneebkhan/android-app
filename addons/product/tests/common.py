...
class TestProductCommon(common.SavepointCase):
    ...
    def setUpClass(cls):
        ...
        cls.product_7_attr1_v1 = cls.product_7_template.attribute_line_ids[0].ptal_product_template_attribute_value_ids[0]
        cls.product_7_attr1_v2 = cls.product_7_template.attribute_line_ids[0].ptal_product_template_attribute_value_ids[1]
        cls.product_7_attr1_v3 = cls.product_7_template.attribute_line_ids[0].ptal_product_template_attribute_value_ids[2]
