...
class Slide(models.Model):
    ...
    # comments
    comments_count = fields.Integer('Number of comments', default=0, compute="_compute_comments_count", store=True)
    # channel
    channel_type = fields.Selection(related="channel_id.channel_type", string="Channel type")
    allow_comment = fields.Boolean(related="channel_id.allow_comment", string="Allows comment")
